...
- A `go` exit whose destination room IS this room is a DOOR BETWEEN TWO HALVES OF ONE ROOM, and a room graph discards it as a self-loop. Eleven rooms have one; it is why travel to 41 said "no route".
